...
# Internal UI objects
from ui import howtoscreen, lobbyscreen, lobbylist, onlinescreen, mainscreen, resourcescreen, optionscreen, aboutscreen, logscreen, logonlyscreen, sound, buttons
...
class Concerto(App):
    ...
    def build(self):
        ...
        self.LogOnlyScreen = logonlyscreen.LogOnlyScreen(CApp=self)
        ...
        self.sm.add_widget(self.LogOnlyScreen)
    ...
    def on_start(self):
        ...
        try:
            key = winreg.CreateKey(winreg.HKEY_CLASSES_ROOT, 'concertoefz')
            winreg.SetValueEx(key, '', 0, winreg.REG_SZ, 'URL:Concerto EFZ Protocol')
        ...
        #TODO integrity check all EFZRevival Assets
        if e != []:
